...
jQuery(function ($) { "use strict";
	...
	$('#contact-submit').click(function (e) {
		...
		where VARIABLE is the variable we are checking (like name, describe),
		...
		The only difference from these checks is the describe checking, we have
		describe.indexOf('@') which checks if there is @ in the describe input field.
		...
		if (describe.length == 0) {
			var error = true;
			$('#describe').css("border-color", "#D8000C");
		} else {
			$('#describe').css("border-color", "#666");
		}
		...
		if (error == false) {
			...
			$.post("/home/together/", $("#contact-form").serialize(), function (result) {
